        ...
        <div className="relative container mx-auto px-6 py-24">
          <AnimatedSection direction="up" delay={100}>
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h1 className="text-5xl md:text-7xl font-black mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {aboutCards.map((card, index) => (
            <AnimatedSection key={card.id} direction="up" delay={200 + index * 100}>
              <div className="group relative bg-base-200 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
